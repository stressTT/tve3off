    ...
    if info.offp == 0 then
        ...
        if parts ~= nil then
			...
			elseif info.part == "80" then
				npc:SetCustomHealthLabel("#TopITroll",  154, 205, 50)
			end
...
function SetModelVip(npc, num)
		...
		elseif npc:GetUnitName() == "npc_dota_hero_enigma" then
			
				wearables:RemoveWearables(npc) 
				
				wearables:AttachWearable(npc, "models/items/enigma/absolute_zero_updated_armor/absolute_zero_updated_armor.vmdl")
				wearables:AttachWearable(npc, "models/items/enigma/absolute_zero_updated_arms/absolute_zero_updated_arms.vmdl")
				wearables:AttachWearable(npc, "models/items/enigma/absolute_zero_updated_head/absolute_zero_updated_head.vmdl")
			
		elseif npc:GetUnitName() == "npc_dota_hero_queenofpain" then
			
				wearables:RemoveWearables(npc) 
				
				wearables:AttachWearable(npc, "models/items/queenofpain/ti8_qop_bat_queen_back/ti8_qop_bat_queen_back.vmdl")
				wearables:AttachWearable(npc, "models/items/queenofpain/ti8_qop_bat_queen_head/ti8_qop_bat_queen_head.vmdl")
				wearables:AttachWearable(npc, "models/items/queenofpain/ti8_qop_bat_queen_legs/ti8_qop_bat_queen_legs.vmdl")
				wearables:AttachWearable(npc, "models/items/queenofpain/ti8_qop_bat_queen_shoulder/ti8_qop_bat_queen_shoulder.vmdl")
				wearables:AttachWearable(npc, "models/items/queenofpain/ti8_qop_bat_queen_weapon/ti8_qop_bat_queen_weapon.vmdl")
		...
		elseif npc:IsTroll() then
			if num == "631" then 
				npc:SetOriginalModel("models/heroes/arc_warden/arc_warden.vmdl")--npc:SetOriginalModel("models/heroes/troll_warlord/troll_warlord.vmdl")
				npc:SetModel("models/heroes/arc_warden/arc_warden.vmdl")--npc:SetModel("models/heroes/troll_warlord/troll_warlord.vmdl")
				npc:SetModelScale(1)
				wearables:RemoveWearables(npc)
				wearables:AttachWearable(npc,"models/items/arc_warden/time_wanderer_arcwarden_arms/time_wanderer_arcwarden_arms.vmdl")--wearables:AttachWearable(npc, "models/items/troll_warlord/lord_of_war_weapon/lord_of_war_weapon.vmdl")
				wearables:AttachWearable(npc,"models/items/arc_warden/time_wanderer_arcwarden_back/time_wanderer_arcwarden_back.vmdl")--wearables:AttachWearable(npc, "models/items/troll_warlord/lord_of_war_armor/lord_of_war_armor.vmdl")
				wearables:AttachWearable(npc,"models/items/arc_warden/time_wanderer_arcwarden_head/time_wanderer_arcwarden_head.vmdl")--wearables:AttachWearable(npc, "models/items/troll_warlord/lord_of_war_head/lord_of_war_head.vmdl")
				wearables:AttachWearable(npc,"models/items/arc_warden/time_wanderer_arcwarden_shoulder/time_wanderer_arcwarden_shoulder.vmdl")--wearables:AttachWearable(npc, "models/items/troll_warlord/lord_of_war_shoulder/lord_of_war_shoulder.vmdl")
			elseif  num == "632" then 
				wearables:RemoveWearables(npc)
